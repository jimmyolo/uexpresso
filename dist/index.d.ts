...
declare namespace express {
  ...
  export interface Application extends Omit<e.Application, 'listen' | 'set' | 'enable' | 'disable' | 'enabled' | 'disabled'> {
    listen(port?: number, hostname?: string, backlog?: number, callback?: () => void): uws.TemplatedApp;
    listen(port?: number, hostname?: string, callback?: () => void): uws.TemplatedApp;
    listen(port?: number, callback?: () => void): uws.TemplatedApp;
    listen(callback?: () => void): uws.TemplatedApp;
    listen(socketPath: string, callback?: () => void): uws.TemplatedApp;
